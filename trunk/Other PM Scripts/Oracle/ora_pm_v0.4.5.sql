...
-- check sga and pga parameter
prompt
prompt *****************************
prompt check sga and pga parameter
prompt *****************************
show parameter ga
...
prompt
prompt *****************************
prompt check sga size
prompt *****************************
show sga

-- check sga all the components in sga
prompt
prompt *************************************
prompt check sga all the components in sga
prompt *************************************
col name for a35;
