#!/usr/bin/perl -w
# Program name: IOSTAT ANALYZER for hpux
...
# Jan.07 2014   Milo Luo      Optimize the GUI and test with strawberry perl 5.18.1.1 on Win 7 64bit.
#
#
#
...
# generate date
my $suffix = strftime "%Y%m%d%H%M%S", localtime;

# Define the excel file name 
my $excel_name="iostat_result_${suffix}.xlsx";
...
print "\n############################\n";
print "# IOSTAT for HPUX Analyzer #"; 
print "\n############################\n";
# Identified disks
print "\n**********************\n";
...
print "Note: All the disks read from configuration file.\n";
print "**********************\n";

print "\n------------------ Choice Menu ----------------------------\n";
print "| 1. Generate all range graph of current iostat file.     |\n";
print "| 2. Generate specify range graph of current iostat file. |\n";
print "-----------------------------------------------------------\n";
print "Choice => ";
...
my $Excel =  Excel::Writer::XLSX->new($excel_name);
