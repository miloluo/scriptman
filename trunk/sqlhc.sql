 ...
 WHERE :health_checks = 'Y'
   ...
   AND (SELECT COUNT(*)
         ...
         WHERE :health_checks = 'Y'
           ...
           AND c1.endpoint_value > c2.endpoint_value) > 0
 GROUP BY
       pt.object_owner,
       pt.object_name ) v
 WHERE :health_checks = 'Y'
 ...
 *
 * ------------------------- */
SPO ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._1_health_check.html;
...
PRO
PRO <head>
PRO <title>^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._1_health_check.html</title>
PRO
...
PRO ^^doc_ver. Report: ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._1_health_check.html</h1>
PRO
...
PRO 2. Ease a compare between two systems that are believed to be similar.<br>
...
PRO        '</tr>'
PRO   FROM (
SELECT (CASE WHEN ROWNUM = 1 THEN 'WITH sc AS (SELECT * FROM gv$sql_shared_cursor WHERE sql_id = ''^^sql_id.'')' ELSE 'UNION ALL' END)||CHR(10)||
 ...
 *
 * ------------------------- */
SPO ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._2_diagnostics.html;
...
PRO
PRO <head>
PRO <title>^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._2_diagnostics.html</title>
PRO
...
PRO <body>
PRO <h1><a target="MOS" href="^^doc_link.^^mos_doc.">^^mos_doc.</a> ^^method.
PRO ^^doc_ver. Report: ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._2_diagnostics.html</h1>
PRO
...
SELECT /*+ NO_MERGE */
       h.plan_hash_value,
       ROUND((SUM(h.elapsed_time_total)/SUM(GREATEST(h.executions_total, 1))) / 1e6, 3) avg_elapsed_time_secs,
       ROUND((SUM(h.cpu_time_total)/SUM(GREATEST(h.executions_total, 1))) / 1e6, 3) avg_cpu_time_secs,
       ROUND((SUM(h.iowait_total)/SUM(GREATEST(h.executions_total, 1))) / 1e6, 3) avg_user_io_wait_time_secs,
       ROUND((SUM(h.ccwait_total)/SUM(GREATEST(h.executions_total, 1))) / 1e6, 3) avg_concurrency_wait_time_secs,
       ROUND((SUM(h.apwait_total)/SUM(GREATEST(h.executions_total, 1))) / 1e6, 3) avg_application_wait_time_secs,
       ROUND((SUM(h.clwait_total)/SUM(GREATEST(h.executions_total, 1))) / 1e6, 3) avg_cluster_wait_time_secs,
       ROUND((SUM(h.plsexec_time_total)/SUM(GREATEST(h.executions_total, 1))) / 1e6, 3) avg_plsql_exec_time_secs,
       ROUND((SUM(h.javexec_time_total)/SUM(GREATEST(h.executions_total, 1))) / 1e6, 3) avg_java_exec_time_secs,
       ROUND(SUM(h.buffer_gets_total)/SUM(GREATEST(h.executions_total, 1))) avg_buffer_gets,
       ROUND(SUM(h.disk_reads_total)/SUM(GREATEST(h.executions_total, 1))) avg_disk_reads,
       ROUND(SUM(h.direct_writes_total)/SUM(GREATEST(h.executions_total, 1))) avg_direct_writes,
       ROUND(SUM(h.rows_processed_total)/SUM(GREATEST(h.executions_total, 1))) avg_rows_processed,
       SUM(GREATEST(h.executions_total, 1)) total_executions,
       --SUM(h.fetches_total) total_fetches,
       --SUM(h.loads_total) total_loads,
       --SUM(h.invalidations_total) total_invalidations,
       --SUM(h.parse_calls_total) total_parse_calls,
 ...
 *
 * ------------------------- */
SPO ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._3_execution_plans.html;
...
PRO
PRO <head>
PRO <title>^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._3_execution_plans.html</title>
PRO
...
PRO <body>
PRO <h1><a target="MOS" href="^^doc_link.^^mos_doc.">^^mos_doc.</a> ^^method.
PRO ^^doc_ver. Report: ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._3_execution_plans.html</h1>
PRO
...
SPO ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._4_sql_detail.html;
SELECT '<!-- '||TO_CHAR(SYSDATE, 'YYYY-MM-DD/HH24:MI:SS')||' -->' FROM dual;
...
SPO ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._5_sql_monitor.sql;
...
BEGIN
  IF :license = 'T' AND '^^rdbms_version.' >= '11' THEN
    ...
    LOOP
      ...
      DBMS_OUTPUT.PUT_LINE('SPO ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._'||TO_CHAR(mon_rec.sql_exec_id)||'_'||TO_CHAR(mon_rec.sql_plan_hash_value)||'_'||TO_CHAR(mon_rec.inst_id)||'_^^time_stamp._5_sql_monitor.html;');
...
-- 11g
@^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._5_sql_monitor.sql
...
HOS tkprof ^^udump_path.*^^script._^^unique_id.*.trc ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._tkprof_from_tool_exec.txt
...
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp..zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._1_health_check.html
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp..zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._2_diagnostics.html
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp..zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._3_execution_plans.html
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp..zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._4_sql_detail.html
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._9_log.zip ^^script..log
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._9_log.zip sql_shared_cursor_sum_^^sql_id..sql
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._9_log.zip sql_shared_cursor_col_^^sql_id..sql
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._9_log.zip sql_shared_cursor_cur_^^sql_id..sql
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._9_log.zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._tkprof_from_tool_exec.txt
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._9_log.zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._5_sql_monitor.sql
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp..zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._9_log.zip
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._5_sql_monitor.zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._*_^^time_stamp._5_sql_monitor.html
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp..zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._5_sql_monitor.zip
...
SET TERM OFF;
HOS cp ^^udump_path.*_DBMS_SQLDIAG_10053_^^unique_id.*.trc   ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._6_10053_trace_from_cursor.trc
HOS copy ^^udump_path.*_DBMS_SQLDIAG_10053_^^unique_id.*.trc ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._6_10053_trace_from_cursor.trc
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp..zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^sql_id._^^time_stamp._6_10053_trace_from_cursor.trc
...
PRO
PRO ^^method. files have been created.
PRO
CL COL;
SET DEF ON;
UNDEFINE 1 2 method script mos_doc doc_ver doc_date doc_link bug_link input_parameter input_sql_id input_license unique_id sql_id signature signaturef license udump_path;
